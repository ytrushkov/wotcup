...
<td><select size="1" name="country" class="text">
    <option selected><?php echo $searchArray['country']; ?>
    <option value=""></option>
...
<td><select size="1" name="version" class="text">
    <option><?php echo $searchArray['HaveVersion']; ?>
    <option value=""></option>
    </select>
</td>
</tr>
...
if ($searchArray['HaveVersion'] != "" && $searchArray['version'] != "") {
    $where .= " AND version ".$searchArray['HaveVersion']." '".$searchArray['version']."' ";
}
if ($searchArray['country'] != '') {
    $where .= " AND country = '".$searchArray['country']."' ";
}
if ($searchArray['HaveVersion'] != '') {
    $where .= " AND country = '".$searchArray['HaveVersion']."' ";
}

// dont show admins
// $_ignore_admin_players = "";
//echo "<br> CFG_ignoreadmins: $CFG_ignoreadmins <br>";
if($CFG_ignoreadmins) {
...
?>
<tr>
<td align="right"><?php echo "<img border='0' height='20px' src='avatars/$row[Avatar]' alt='avatar' />"?></td>
...
<td><?php echo "<img src='graphics/flags/$row[country].bmp' align='absmiddle' border='1'>"?></td>
