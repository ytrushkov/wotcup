...
if (isset($_GET['read'])) {
    $get_read = $_GET['read'];
    $sql = "SELECT * FROM $newstable WHERE news_id = $get_read ORDER BY news_id DESC";
...
?>
<tr>
<td align='center'><a href='news-view.php?read=<?php echo $row['news_id'] ?>'><img border='1' src='../images/view.png' width='18' height='18' align='middle' alt="View" /></a></td>
...
<td align='center'><a href='news-delete.php?edit=<?php echo $row['news_id'] ?>&title=<?php echo $row['date']."-".$row['title'] ?>'><img border='1' src='../images/delete.gif' width='18' height='18' align='middle' alt="Delete" /></a></td>
