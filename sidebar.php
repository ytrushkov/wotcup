...
if ((mysql_num_rows($result)==0) && isset($_SESSION['username'])) {
    echo "<div align='left'><a href='playnow.php'><img border='0' src='graphics/waiting.png'></a></div><br />";
...
/*
echo "</ol><br><div align='left'><a href='friends.php'><img border='0' src='graphics/friendslist.png'></a></div><br />";
*/
// Show  number of registered CONFIRMED users


$sql=mysql_query("SELECT count(*) FROM $playerstable WHERE (Confirmation = \"Ok\" OR Confirmation = '')".$_ignore_admin_players);
$number=mysql_fetch_row($sql);

echo "<br /><br /><b>Registered Clans:</b> ".$number[0];
...
echo "<br /><b>Ranked Clans: </b>".$rankedPlayers[0];
