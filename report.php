...
<table border="1" cellpadding="5" cellspacing="0">
	...
	<tr>
        ...
        <td><?php echo isset($cloneresult['winnerProvisional']) ? "Yes" : "No"; ?></td>
	...
	<tr>
			...
			<td><?php echo isset($cloneresult['loserProvisional']) ? "Yes" : "No"; ?></td>
...
<th><?php echo $_SESSION['ladder_id']; ?> Match Report</th>
...
<td><?php echo $_SESSION['username']; ?> won over</td>
	...
	?>
	<tr><td>.<?php echo $replayfileextension." ";?> screenshot (optional)</td><td><input name="uploadedfile" type="file" /></td></tr><br />
	<?php } ?>
	
	<tr><td>sportsmanship</td><td><select size="1" name="sportsmanship">
		<option selected="selected" value="">-- No sportmanship rating --</option>
		<option value="1">1 - Lousy conduct, the player behaved unacceptably.</option>
...
<tr><td valign="top">
<p valign="top">game comment / replay link</p></td>
