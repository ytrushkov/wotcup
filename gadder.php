...
<th align="left" width='15%'>Avatar</th>

<th align="left">Clans&nbsp; &nbsp;</th>
</tr>
</thead>
...
while ($row = mysql_fetch_array($result)) {
  ...
  if  (($row['rating'] < ($classbaseelo - GADDER_ELO_RANGE)) || (($row['rating'] >= $classbaseelo) && ($previousrating != $classbaseelo))) {
    echo "</td></tr>$trclass<td class=\"gadderrank\">$rank</td><td align=\"center\"><img border='0' height='32px'  src='avatars/".$row['Avatar']."'></td><td>$flagprefix ";?>
